...
\cite{noauthor_sentiment_nodate}
...
Second half of the 20c saw a computerized analysis become a reality. Bag of word approaches have been seen as early as 1954... \cite{harris_distributional_1954}
...
ELO system \cite{noauthor_elo_2023} ensures that in player versus player games there is balance. Each player can't go against player very far from their own skill level.
...
Syllogism based games serve to uncover enthymemes as mentioned before \cite{noauthor_finding_nodate}. 
...
The other criterion is the number of downloads - if larger than 150 it is better than global average, if more than 1300, over global average \cite{noauthor_average_nodate}.
...
\cite{noauthor_supabase-js_2023}
\cite{noauthor_pocketbase_2023}
