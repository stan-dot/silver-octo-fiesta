...
This is an exploratory project, as the design and functionalities list is not avaialbatble rightnow.
Design is provided and some of the functoinalities were done as a proof-of-concept. 
That is on the spectrum of design -> proof of concept -> prototype -> MVP.

goal - besides argumetn mining - is critical thinking skills imporovement
...
One of the features of this paper to note is its use of Amazon's "Mechanical Turk" service for contributions. Paid volunteers did the annotations. THat was compared to expert performance
...
global opinions on every statement
% todo describe interaction with AIFdb
...
- multiplayer
- deployment
- annotation in debate - also a global snapshot
